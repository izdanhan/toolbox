...
Bushcrafteri laittaa pakissa ruokaa nuotiolla talvisessa metsässä.
...
Metsästäjä haulikko sylissä yllään Särmä TST Recon Smock ja Särmä TST L4 kenttätakkiMetsästys on hyvä tapa täydentää muonavaroja eräreissulla.
...
Vierekkäin vasemmalta myrskytikut, vedenpitävät tulitikut, kipinärauta ja perinteiset tuluksetTässä muutamia tulentekovälineitä helpommasta haastavampaan. Vasemmalta myrskytikut, tulitikut, kipinärauta ja vanhat kunnon tulukset.
...
Maastopukuun pukeutunut mies laavukankaan alla makuullaUudemmilla varusteillakin voi halutessaan harjoittaa kurjuuden maksimointia.
...
Mies vuolee kalikkaa metsässä puukollaLeirissä voi värkkäillä vaikka erillisen keittokatoksen toisesta tarpista, tehdä kolmijalkoja ja vartaita kokkailuun, testailla solmuja, veistellä lusikoita ja paistinlastoja, vuolla kiehisiä, väsätä sytykkeitä tai vaikkapa rakentaa maauunin, kunhan maasto, palovaroitukset ja maanomistaja sen sallivat.
...
Ensiapupakkaus avattu metsässä repun päälläModerni ensiapupakkaus on varusteiden oleellinen osa, olit millainen eränkävijä hyvänsä.
...
Mies metsässä yllään Varustelekan Särmä TST Woolshell -pukuWoolshell on iloisen bushcrafterin valinta.
...
Läjä bushcraft-kirjoja suomeksi ja englanniksi

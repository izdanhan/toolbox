...
# Check if an argument was passed directly from a keybind
if [ -n "$1" ]; then
    SELECTION="$1"
else
    # Menu options for Rofi if run without arguments
...
# Force swaybg to paint the newly activated display instantly
pkill swaybg
swaybg -i /home/daniel/Pictures/wallpaper.jpg &

...
choice=$(echo -e "$options" | rofi -dmenu -p "System Config" -theme-str 'window { width: 320px; height: 160px; font: "UbuntuMono Nerd Font 14"; } inputbar { enabled: false; } listview { scrollbar: false; }')    

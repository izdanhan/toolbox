...
choice=$(echo -e "$options" | rofi -dmenu -p "System Config" -theme-str 'window { width: 320px; height: 170px; font: "JetBrainsMono Nerd Font 11"; } inputbar { enabled: false; } listview { scrollbar: false; }')
